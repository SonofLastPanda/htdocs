...
<html>
 ...
 <body>
    <div class="container">
      ...
      </div><div class="boxed_m"><h3>Want updates?<br>Log in!</h3><div class="p2">This way you can get updates about your favorite destinations.<br> CoTRACK-19 is updated regularly with new information from government websites, national authorities and other official information channels. We stay updated so that you don't have to!</div></div><div class="boxed_r"><h3>Browse all Countries</h3></div>
</body>
</div>
</div>
</html>
